...
export default class Hyperlink {
  ...
  renderActions () {
    ...
    this.addOption(this.nodes.selectTarget, this.i18n.t('Select target'), '_blank')
    ...
    this.nodes.buttonSave.innerHTML = this.i18n.t('确认')
  ...
  savePressed (event) {
    ...
    const target = this.nodes.selectTarget.value || ''
  ...
  insertLink (link, target = '_blank', rel = '') {
